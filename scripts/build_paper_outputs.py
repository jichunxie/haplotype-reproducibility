...
def main() -> None:
    ...
    shutil.copy2(RANKING / "figure_ranking_simulation_results_v77.pdf", MAIN)
    for name in (
    ...
    shutil.copy2(RANKING / "figure_ranking_simulation_design_v77.pdf", SUPP)
    ...
    run(DATA / "make_supptable_ST3.py")
    expected = [
        ...
        *[SUPP / name for name in (
        ...
        TABLES / "ST3_cohort_haplotype_agreement.tex",
    ]
